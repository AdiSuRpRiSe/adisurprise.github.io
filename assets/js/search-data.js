    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-początek-funkcjonowania-strony",
          title: 'Początek funkcjonowania strony',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/AdiSuRpRiSe", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/adam-kamos", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0004-2891-3749", "_blank");
        },
      },{
